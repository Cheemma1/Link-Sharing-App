  ...
  return (
               <> 
                  <div className="m-[0_0_2.5rem_0] flex flex-col self-start w-[fit-content] box-sizing-border">
                    ...
                    <span className="break-words font-['Instrument_Sans'] font-[var(--body-m-font-weight,400)] text-[1rem] leading-[var(--body-m-line-height,1.5)] text-[var(--grey,#737373)]">
                  ...
                  <div className="flex flex-col items-center w-[fit-content] box-sizing-border">
                    <div className="rounded-[0.8rem] bg-[var(--light-grey,#FAFAFA)] m-[0_0_1.5rem_0] flex flex-row p-[1.3rem_2.6rem_1.3rem_1.3rem] w-[fit-content] box-sizing-border">
                      <div className="m-[5.3rem_9.5rem_5.3rem_0] inline-block break-words font-['Instrument_Sans'] font-[var(--body-m-font-weight,400)] text-[1rem] leading-[var(--body-m-line-height,1.5)] text-[var(--grey,#737373)]">
                        Profile picture
                      </div>
                      <div className="flex flex-row box-sizing-border">
                        ...
                        <div className="m-[4.9rem_0_4.9rem_0] inline-block break-words font-['Instrument_Sans'] font-[var(--body-s-font-weight,400)] text-[0.8rem] leading-[var(--body-s-line-height,1.5)] text-[var(--grey,#737373)]">
                ...
                <div className="flex flex-col items-end w-[50.5rem] box-sizing-border">
                  <div className="bg-[var(--borders,#D9D9D9)] m-[0_0_1.5rem_0] w-[50.5rem] h-[0.1rem]">
                  </div>
